...
heartrate #NOT tidy bc the drug is actually an observation; the column names are actual observations; treatment type (a,b,c,d) should be a different column; the consequence of tidying the data would be making a larger data set
```
...
relig_income %>% 
  pivot_longer(-religion,
               names_to = "income_level", #make a new column called "drug"
               values_to="amount")
```
...
billboard2 <- 
  billboard %>% 
  pivot_longer(wk1:wk76, #a range of columns; good if data taken in a sequential way
               names_to = "week",
               values_to = "rank", 
