...
The difference between R and R Studio is that R is a scripting language (a program), but RStudio is a GUI (Graphical User Interface). GitHub is an online area where programmers put and save versions of their code, they can also collaborate through GitHub.
