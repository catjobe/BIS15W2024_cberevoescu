...
##### The smallest owl is from the genus glaucidium, species name passerinum. Its common name is the Eurasian pygmy owl.

More about the [Eurasian pygmy owl]()
...
homerange %>% 
  filter(taxon == "birds") %>% 
  select(species, mean_hra_m2) %>% 
  arrange(mean_hra_m2)

```

```{r}
filter(homerange, species == "cyanea")
```


##### Thus, the species with the largest homerange is the cyanea, common name indigo bunting.
